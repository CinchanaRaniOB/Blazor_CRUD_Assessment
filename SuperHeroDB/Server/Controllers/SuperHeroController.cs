...
namespace SuperHeroDB.Server.Controllers
{
    ...
    public class SuperHeroController : ControllerBase
    {
        ...
        static List<SuperHero> heroes = new List<SuperHero> {
            new SuperHero { Id = 1, FirstName = "Peter", LastName = "Pan", HeroName = "Spiderman", Comic = comics[0] },
            new SuperHero { Id = 2, FirstName = "Bruce", LastName = "Lee", HeroName = "Batman", Comic = comics[1] },
        };
        ...
        public async Task<IActionResult> GetSuperHero(int id)
        {
            ...
            if (hero == null)
                return NotFound("Super Hero didn't found.");
